    ...
    <div className="flex flex-col justify-center items-center w-full gap-5 p-4 bg-black pb-16 2xl:py-28">
        ...
        <div className="flex flex-col lg:flex-row gap-4 justify-evenly w-full 2xl:pb-14">
            <div className="flex flex-col gap-2 font-Raleway">
                <h1 className="font-bold text-[#80AF81] text-base lg:text-lg mb-2 font-Precursive border-b-2 border-dotted">ABOUT US</h1>
            ...
            <div className="flex flex-col gap-2">
                <h1 className="font-bold text-[#80AF81] text-base lg:text-lg mb-2 font-Precursive border-b-2 border-dotted">CUSTOMER CARE</h1>
            ...
            <div className="flex flex-col gap-2">
                <h1  className="font-bold text-[#80AF81] text-base lg:text-lg mb-2 font-Precursive border-b-2 border-dotted">GET IN TOUCH</h1>
            ...
            <div className="flex flex-col">
                    <h1  className="font-bold text-[#80AF81] text-base lg:text mb-4 font-Precursive border-b-2 border-dotted">FOLLOW US</h1>
