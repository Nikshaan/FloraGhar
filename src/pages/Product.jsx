        ...
        <div className="h-full flex-auto p-3 pb-12 flex flex-col sm:flex-row justify-center items-center lg:py-20 bg-[#D6EFD8]">
            ...
            <div className="flex flex-col justify-center items-center mt-2 sm:w-1/2">
                <div className="px-2 sm:px-4 sm:pt-4 m-auto sm:m-10 flex flex-col">
                    <p className="text-3xl sm:text-5xl 2xl:text-8xl font-semibold font-Raleway">{productData.name}</p>
                    <p className="text-gray-500 sm:text-2xl font-semibold font-Precursive">{productData.type?`${productData.type}` : null}</p>
                ...
                {   
                    ...
                    <div onClick={() => {
                      ...
                      className="flex gap-2 cursor-pointer justify-center items-center bg-white border-2 border-[#1A5319] px-2 rounded-full py-0.5 my-2"> 
                        <p className="text-xl font-semibold font-Precursive p-0.5 px-1">CART</p>
                        <img className="w-3 h-3" src={constants.plus} />
                    </div>:
                    <div className="flex gap-6 cursor-pointer justify-center items-center bg-white border-2 border-[#1A5319] px-2 rounded-full py-0.5 my-2">
                        <img onClick={() => {
