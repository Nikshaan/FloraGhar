      ...
      <div className="flex flex-col w-full h-full relative">
        ...
        <div className="flex-1 flex flex-col">
            <div className={"bg-[#508D4E] min-h-20 flex gap-4 justify-between items-center px-2 md:px-10 border-2 border-t-0 border-black"}>
                  ...
                  <p className="text-nowrap lg:text-3xl font-bold font-sans underline">SEED COLLECTION</p>
            ...
            <div className="bg-[#D6EFD8] flex-1 border-l-2 border-r-2 border-black p-6 2xl:py-52">
